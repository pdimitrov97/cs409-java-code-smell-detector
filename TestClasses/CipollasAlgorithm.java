...
public class CipollasAlgorithm extends abcd {
    ...
    private static class Triple {
        ...
        class Triple3 {
            ...
            Triple3(BigInteger x, BigInteger y, boolean b) {
                this.x = x;
                this.y = y;
                this.b = b;
            }
            ...
            class Triple4 {
                ...
                Triple4(BigInteger x, BigInteger y, boolean b) {
                    this.x = x;
                    this.y = y;
                    this.b = b;
                }
                ...
                class Triple5 {
                    ...
                    Triple5(BigInteger x, BigInteger y, boolean b) {
                        this.x = x;
                        this.y = y;
                        this.b = b;
                    }
                    ...
                    class Triple6 {
                        ...
                        Triple6(BigInteger x, BigInteger y, boolean b) {
                            this.x = x;
                            this.y = y;
                            this.b = b;
                        }
                        ...
                        class Triple7 {
                            ...
                            Triple7(BigInteger x, BigInteger y, boolean b) {
                                this.x = x;
                                this.y = y;
                                this.b = b;
                            }
                            ...
                            class Triple8 {
                                ...
                                Triple8(BigInteger x, BigInteger y, boolean b) {
                                    this.x = x;
                                    this.y = y;
                                    this.b = b;
                                }
                                ...
                                class Triple9 {
                                    ...
                                    Triple9(BigInteger x, BigInteger y, boolean b) {
                                        this.x = x;
                                        this.y = y;
                                        this.b = b;
                                    }
    ...
    private static Triple c(String ns, String ps) {
     ...
     class Triple2 {
            ...
            Triple2(BigInteger x, BigInteger y, boolean b) {
                this.x = x;
                this.y = y;
                this.b = b;
            }
